...
<head>
  ...
  <!-- CSS Files -->
  <link href="{{ asset('coopfon') }}/css/material-dashboard.css?v=2.1.0" rel="stylesheet" />
            ...
            <ul class="dropdown-menu">
              ...
              <li class="active">
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                  <img src="{{ asset('coopfon') }}/img/sidebar-1.jpg" alt="">
                </a>
              </li>
              <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                  <img src="{{ asset('coopfon') }}/img/sidebar-2.jpg" alt="">
                </a>
              </li>
              <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                  <img src="{{ asset('coopfon') }}/img/sidebar-3.jpg" alt="">
                </a>
              </li>
              <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                  <img src="{{ asset('coopfon') }}/img/sidebar-4.jpg" alt="">
                </a>
              </li>
