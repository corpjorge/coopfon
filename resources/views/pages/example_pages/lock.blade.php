@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'classPage' => 'lock-page', 'activePage' => 'lock', 'title' => __('Material Dashboard'), 'pageBackground' => asset("coopfon").'/img/lock.jpg'])
      ...
      <div class="card card-profile text-center card-hidden">
        <div class="card-header ">
          <div class="card-avatar">
            <a href="#pablo">
              <img class="img" src="{{ asset('coopfon') }}/img/faces/avatar.jpg">
            </a>
          </div>
        </div>
        <div class="card-body ">
