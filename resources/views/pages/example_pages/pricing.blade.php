@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'classPage' => 'pricing-page', 'activePage' => 'pricing', 'title' => __('Material Dashboard'), 'pageBackground' => asset("coopfon").'/img/bg-pricing.jpg'])
